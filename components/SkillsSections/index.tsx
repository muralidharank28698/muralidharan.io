    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(255,107,43,0.1) 0%, transparent 60%)",
            filter: "blur(70px)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(56,189,248,0.08) 0%, transparent 60%)",
            filter: "blur(60px)",
          }}
        />
      </div>

      <div className="flex flex-col items-start md:items-center max-w-4xl mx-auto text-left md:text-center mb-16 px-6 md:px-0">
        <motion.div
          initial="hidden"
          whileInView="show"
          viewport={VP}
        ...
        >
          A carefully curated collection of modern frameworks, robust
          architectures, and reliable tools I use to engineer scalable,
